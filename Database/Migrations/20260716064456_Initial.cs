    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FeedPlaylists", x => new { x.FeedId, x.PlaylistId });
                    table.ForeignKey(
                        name: "FK_FeedPlaylists_Feeds_FeedId",
                        column: x => x.FeedId,
                        principalTable: "Feeds",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FeedPlaylists_Playlists_PlaylistId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FeedPlaylists_PlaylistId",
                table: "FeedPlaylists",
                column: "PlaylistId");
